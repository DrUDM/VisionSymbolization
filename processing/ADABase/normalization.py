...
class Normalization():
    ...
    def process(self): 
        ...
        to_keep = []
        thr = self.config['general']['available_segment_prop']
            ...
            for label in self.config['data']['label_set']:   
                try:
                    ...
                    if l_o >= thr and l_s >= thr and l_a >= thr:
                        ...
                        print('Rejected file: {s}_{l}'.format(s=subject, l=label)) 
                except:
                    print('No file: {s}_{l}'.format(s=subject, l=label)) 
                    pass
    ...
    def process_normalization(self, 
        ...
        for file in data.keys():  
            ...
            filename = 'output/ADABase/normalized_features/{f_}.csv'.format(f_=file) 
